        ...
        <div className='h-64 sm:h-40'>
            ...
            <Carousel.Panel id="database-tools">
                ...
                <Carousel.Item itemKey="database-postgres">
                    <Skill.Item title="PostgreSQL" iconUrl="/postgresql.svg" progress={90} />
                </Carousel.Item>
                ...
                <Carousel.Item itemKey="database-mongodb">
                    <Skill.Item title="MongoDB" iconUrl="/mongodb.svg" progress={70} />
                </Carousel.Item>

                <Carousel.Item itemKey="database-redis">
                    <Skill.Item title="Redis" iconUrl="/redis.svg" progress={60} />
                </Carousel.Item>
